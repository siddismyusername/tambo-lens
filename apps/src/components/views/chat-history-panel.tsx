...
const THREAD_STORAGE_KEY = "tambo-lens-current-thread-id";
...
export function ChatHistoryPanel({ collapsed = false }: ChatHistoryPanelProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      {/* Thread list */}
      <div className="flex-1 overflow-y-auto max-h-50 space-y-0.5">
        ...
        {sortedThreads.map((t) => {
          ...
          const displayName = t.name || formatThreadDate(t.createdAt);
