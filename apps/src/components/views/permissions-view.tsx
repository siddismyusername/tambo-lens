          ...
          <Card className="bg-muted/50">
            <CardContent className="py-3">
              <p className="text-sm text-muted-foreground">
                ...
                Control which tables the AI can query. Only allowed tables will
                be accessible in analytics conversations. Row limits prevent
          ...
          {loading && !localPerms.length ? (
            ...
            localPerms.map((perm) => {
              ...
              return (
                <Card
                  key={perm.tableName}
                  className={perm.allowed ? "border-primary/30" : "opacity-60"}
                >
