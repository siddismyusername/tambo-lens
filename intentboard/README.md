...
IntentBoard is a plug-and-play AI interface that sits on top of your existing databases. Connect your PostgreSQL, MySQL, or MongoDB databases and explore, analyze, and visualize data using natural language — no SQL or dashboard-building required.
...
DATABASE_URL=postgresql://postgres:password@localhost:5432/intentboard
...
Create the `intentboard` database in PostgreSQL:

```sql
CREATE DATABASE intentboard;
```
